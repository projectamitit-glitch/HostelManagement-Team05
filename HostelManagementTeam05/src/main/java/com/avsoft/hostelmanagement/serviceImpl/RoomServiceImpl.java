...
public class RoomServiceImpl implements RoomService {
	...
	public RoomDto createRoom(RoomDto dto) {
		...
		//Floor floor = floorRepository.findById(dto.getFloorId()).orElseThrow(()->new RoomServiceException("Floor not found with id: " + dto.getFloorId()), HttpStatus.NOT_FOUND));
	...
	public RoomDto getRoomById(Long id) {
		Room room = roomRepository.findById(id)
                .orElseThrow(() -> new RoomServiceException("Room not found with id: " + id,HttpStatus.NOT_FOUND));
