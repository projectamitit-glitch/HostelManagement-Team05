...
public class FloorServiceImpl implements FloorService {
	...
	@Override
	public PaginationResponse<Floor> getAllFloors(Integer pageNumber, Integer pageSize) {

		Pageable pageable = PageRequest.of(pageNumber, pageSize);
		Page<Floor> pageFloor = floorRepo.findAll(pageable);

		PaginationResponse<Floor> postResponse = new PaginationResponse<>();
		postResponse.setContent(pageFloor.getContent());
		postResponse.setPageNumber(pageFloor.getNumber());
		postResponse.setPageSize(pageFloor.getSize());
		postResponse.setTotalElements(pageFloor.getTotalElements());
		postResponse.setTotalPages(pageFloor.getTotalPages());
